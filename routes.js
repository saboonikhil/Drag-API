...
router.get('/api/admin/partners/:dID', partner_controller.partner_detail); //partner Routes-authentication and authorisation both required
router.put('/api/admin/partners/:dID', partner_controller.partner_update);
router.delete('/api/admin/partners/:dID', partner_controller.partner_delete); //Routes-authentication and authorisation both required
